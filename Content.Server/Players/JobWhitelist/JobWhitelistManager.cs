...
// using Content.Shared.Players.PlayTimeTracking; // LoneStar, removed
...
public sealed class JobWhitelistManager : IPostInjectInit
{
    ...
    // private readonly Dictionary<NetUserId, bool> _globalWhitelists = new(); // LoneStar, removed

    public void Initialize()
    {
        _net.RegisterNetMessage<MsgJobWhitelist>();
        // _net.RegisterNetMessage<MsgWhitelist>(); // LoneStar, removed
    }
    ...
    private async Task LoadData(ICommonSession session, CancellationToken cancel)
    {
        ...
        // // Frontier: global whitelists // LoneStar, removed
    ...
    {
        if (!_whitelists.TryGetValue(player, out var whitelists)) // LoneStar
        {
        ...
        return whitelists.Contains(job); // LoneStar
    }
    ...
    public bool IsWhitelisted(NetUserId player, ProtoId<GhostRolePrototype> ghostRole)
    {
        ...
        return whitelists.Contains(ghostRole); // LoneStar
    }
